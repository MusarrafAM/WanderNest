...
export const createBookingAction = async (prevState: {
  ...
  // this means when click a booking a booking will be created with paymentStatus false.
  // only after competed the stripe payment only it will change to true
  // This is to remove all the unpaid bookings (payment status false) when create a new booking.
...
//! We used multiple promise with promise.all, and used aggregate function on query.
//! fetchRentals is an interesting action, we connect 2 model in here
...
// This is to fetch single rental details to show in the edit page
